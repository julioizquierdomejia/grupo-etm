...
/*	function updatePedido(pPedido){
  ...
  $(function() {
    ...
    $( "#CrearHojaPicking" ).button().on( "click", function() {
		if ($("input[name='seleccion[]']:checked").length>0){
		//console.log($("input[name='seleccion[]']:checked").serialize());
			...
			alert("Solo se puede generar el picking en pedidos Aprobados");	
		}
...
<div id="DespacharPedido" title="Despacho Pedido">
  ...
  <form id="frmPedido">
    <fieldset>
      ...
      <input type="text" id="txtcolegio" name="txtcolegio" style="width:200px;" class="ui-widget-content ui-corner-all" disabled>
      </div>
      </div>
      <div class="Row">
      <div class="Cell">
      ...
      <input type="text" name="txtfechaentrega" id="txtfechaentrega" class="ui-widget-content ui-corner-all" style="width:200px;" disabled>
      </div>
      <div class="Cell" style="vertical-align:middle;">
      <label for="txtobservaciones">Observaciones:</label>
      <textarea rows="2" cols="36" name="txtobservaciones" id="txtobservaciones" class="ui-widget-content ui-corner-all" value="" disabled>
      </textarea>
      </div>
      </div>
      </div>
