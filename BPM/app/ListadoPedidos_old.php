...
<head>
  ...
  $(function() {
	...
	$("#AddProducto").on("click", function() {
		...
		/*
		Lo deshabilito porque est�1�71�1�77�1�71�1�77 fallando el uso de los botones.
		$('#pedidos').selectable({
			filter:'tbody tr',
		});
		*/
	...
	$(document).on("click", ".buttonVer", function(){
		...
		$.getJSON("selPedido.php?tipo=Pedido&pedido="+$(this).attr("name"), function(pedidos){
	...
	$(document).on("dblclick", "#pedidos tbody tr", function(){
		...
		$.getJSON("selPedido.php?tipo=Pedido&pedido="+$(this).attr("title"), function(pedidos){
  ...
  <style>
	...
	/*Revisar el dise�1�71�1�770�1�71�1�779o*/
