...
<div class="envoltura" style="height:700px;">
	...
	<h1>Reunión con el presidente y directores de AIEC</h1>
	<div class="imagenPrincipal">
		<img src="img/banner/aiec_.jpg" width="680" height="260">
	</div>
	<p>En el PAD (Escuela de Dirección de la Universidad de Piura) tuvimos la oportunidad de reunirnos con el presidente y directores de la Asociación de Instituciones Educativas Católicas (AIEC). En esta reunión se buscó presentar nuestra propuesta editorial y comunicar a este importante grupo de colegios las fortalezas de nuestras colecciones.
	</p>
