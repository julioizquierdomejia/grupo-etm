...
<div class="envoltura">
	...
	<div class="baseAzul">
		<div class="baseTitulo">
			<h2>MATEMÁTICA PRIMARIA</h2>
		</div>
		<div class="listaColecciones">
			<ul>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula1.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla1.php">Revisar contenido</a>
					</div>
				</li>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula2.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla2.php">Revisar contenido</a>
					</div>
				</li>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula3.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla3.php">Revisar contenido</a>
					</div>
				</li>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula4.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla4.php">Revisar contenido</a>
					</div>
				</li>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula5.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla5.php">Revisar contenido</a>
					</div>
				</li>
				<li>
					<img src="img/colecciones/primaria/matematica/caratula6.jpg">
					<div class="verLibro">
						<img src="img/librito.png">
						<a href="matla6.php">Revisar contenido</a>
					</div>
				</li>
			</ul>
		</div>
		<div class="menuColecciones">
			<ul class="principal">
				...
				<li class="activado">
					...
					<ul class="subMenu">
						<li class="subMenuAzul"><a class="textoAzul" href="coleccionescomp.php">Comunicación Primaria</a></li>
						<li class="subMenuAzul"><a class="textoAzul subMenuActivo">Matemática</a></li>
					</ul>
				</li>
