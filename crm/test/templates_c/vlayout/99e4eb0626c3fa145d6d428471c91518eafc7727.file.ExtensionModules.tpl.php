<?php /* Smarty version Smarty-3.1.7, created on 2014-09-25 19:58:02
         compiled from "/home/grupo/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Settings/ExtensionStore/ExtensionModules.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1384019944542473cacb49a1-89926297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99e4eb0626c3fa145d6d428471c91518eafc7727' => 
    array (
      0 => '/home/grupo/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Settings/ExtensionStore/ExtensionModules.tpl',
      1 => 1411674744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1384019944542473cacb49a1-89926297',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_542473cc5a007',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542473cc5a007')) {function content_542473cc5a007($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/grupo/public_html/crm/libraries/Smarty/libs/plugins/modifier.truncate.php';
?>
...
?><?php if ($_smarty_tpl->tpl_vars['EXTENSION']->value->isAlreadyExists()){?><?php $_smarty_tpl->tpl_vars['EXTENSION_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance($_smarty_tpl->tpl_vars['EXTENSION']->value->get('name')), null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['EXTENSION_MODULE_MODEL'] = new Smarty_variable('false', null, 0);?><?php }?><div class="span6"><div class="extension_container extensionWidgetContainer"><div class="extension_header"><div class="font-x-x-large boxSizingBorderBox" style="cursor:pointer"><?php echo vtranslate($_smarty_tpl->tpl_vars['EXTENSION']->value->get('label'),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"/></span></div><div class="extensionInfo"><div class="row-fluid"><?php $_smarty_tpl->tpl_vars['ON_RATINGS'] = new Smarty_variable($_smarty_tpl->tpl_vars['EXTENSION']->value->get('avgrating'), null, 0);?><div class="span5"><span class="rating" data-score="<?php echo $_smarty_tpl->tpl_vars['ON_RATINGS']->value;?>
...
)<?php }?></span></div><div class="span7"><div class="pull-right"><button class="btn installExtension addButton" style="margin-right:5px;"><?php echo vtranslate('LBL_MORE_DETAILS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
